...
public class Gen6Constants {
    ...
    public static void setMultiBattleStatusXY(List<Trainer> trs) {
        ...
        setAlwaysMultiBattleStatus(trs, 108, 111, 348, 350, 438, 439, 470, 472, 476, 610, 611, 612);
    }
    ...
    public static void setMultiBattleStatusORAS(List<Trainer> trs) {
        ...
        setAlwaysMultiBattleStatus(trs, 683, 687, 688, 691, 694, 698, 900, 901, 902, 903, 904, 905);
    }
